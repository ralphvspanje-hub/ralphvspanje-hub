...
I run an e-commerce business, build apps, and study Data Science at Erasmus University Rotterdam. Usually all three at once.
...
**[Meditations](https://github.com/ralphvspanje-hub/meditations)** - Personal learning wiki maintained by an AI agent named Marcus A.. Started as a save-and-compile system inside ProngAgent with Obsidian, then refined with Karpathy's LLM Wiki pattern into its own repo. I drop observations, Marcus clusters them into patterns and keeps a compounding knowledge base. Plain markdown, any AI agent can pick it up. [Read more](https://github.com/ralphvspanje-hub/meditations)
...
I use AI agents heavily, but more as a workflow than a shortcut. New ideas go through a Claude project I set up as a virtual CTO before I write any code. It pushes back. If something survives that, it becomes an issue in Linear, then a plan, then I build it in Cursor.

The repos themselves have `CLAUDE.md` files in every directory so agents know what's there and what not to break. They also write to `AGENT_LOG.md` when something confuses them, and fix the docs on the spot. The context just keeps getting more accurate the more I use it.
